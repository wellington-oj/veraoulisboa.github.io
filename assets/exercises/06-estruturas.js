...
window.exerciseTopics.push({
  ...
  exercises: [
    ...
    {
      id: 'arvore-procura',
      animation: `<div class="cax"><style>.bst{display:grid;grid-template-columns:1fr 1fr;gap:14px;width:100%}.bst-col{display:flex;flex-direction:column;align-items:center;gap:5px}.bst-t{font-size:10px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#64748b;margin-bottom:2px}.bst-items{display:flex;gap:4px;align-items:center;flex-wrap:wrap;justify-content:center}.bst-item{width:28px;height:28px;border-radius:6px;display:grid;place-items:center;font-size:12px;font-weight:800;animation-duration:10s;animation-iteration-count:infinite;animation-timing-function:ease}.bst-arr{color:#94a3b8;font-size:11px}.li0{background:#e8eef7;color:#1f2937;animation-name:li0}.li1{background:#e8eef7;color:#1f2937;animation-name:li1}.li2{background:#e8eef7;color:#1f2937;animation-name:li2}.li3{background:#e8eef7;color:#1f2937;animation-name:li3}.li4{background:#e8eef7;color:#1f2937;animation-name:li4}.tn{width:28px;height:28px;border-radius:999px;display:grid;place-items:center;font-size:12px;font-weight:800;background:#2f5d78;color:white;animation-duration:10s;animation-iteration-count:infinite;animation-timing-function:ease}.tn8{animation-name:tn8}.tn3{animation-name:tn3}.tn6{animation-name:tn6}.bst-cnt{font-size:11px;font-weight:700;color:#16a34a;height:15px;animation-duration:10s;animation-iteration-count:infinite;animation-timing-function:ease}.lc{animation-name:lcIn}.tc{animation-name:tcIn}.bst-sub{font-size:10px;color:#94a3b8;margin-top:2px;text-align:center}@keyframes li0{0%,4%{background:#e8eef7;color:#1f2937}5%,49%{background:#d97706;color:white}50%,100%{background:#e8eef7;color:#1f2937}}@keyframes li1{0%,11%{background:#e8eef7;color:#1f2937}12%,49%{background:#d97706;color:white}50%,100%{background:#e8eef7;color:#1f2937}}@keyframes li2{0%,18%{background:#e8eef7;color:#1f2937}19%,49%{background:#d97706;color:white}50%,100%{background:#e8eef7;color:#1f2937}}@keyframes li3{0%,25%{background:#e8eef7;color:#1f2937}26%,49%{background:#d97706;color:white}50%,100%{background:#e8eef7;color:#1f2937}}@keyframes li4{0%,32%{background:#e8eef7;color:#1f2937}33%,49%{background:#16a34a;color:white}50%,100%{background:#e8eef7;color:#1f2937}}@keyframes tn8{0%,54%{background:#2f5d78}55%,89%{background:#d97706}90%,100%{background:#2f5d78}}@keyframes tn3{0%,62%{background:#2f5d78}63%,89%{background:#d97706}90%,100%{background:#2f5d78}}@keyframes tn6{0%,70%{background:#2f5d78}71%,88%{background:#16a34a}89%,100%{background:#2f5d78}}@keyframes lcIn{0%,32%{opacity:0}33%,49%{opacity:1}50%,100%{opacity:0}}@keyframes tcIn{0%,70%{opacity:0}71%,88%{opacity:1}89%,100%{opacity:0}}</style><div class="bst"><div class="bst-col"><div class="bst-t">Lista</div><div class="bst-items"><div class="bst-item li0">8</div><div class="bst-item li1">3</div><div class="bst-item li2">10</div><div class="bst-item li3">1</div><div class="bst-item li4">6</div></div><div class="bst-cnt lc">✔ 5 passos</div></div><div class="bst-col"><div class="bst-t">Árvore</div><div class="bst-items"><div class="tn tn8">8</div><div class="bst-arr">→</div><div class="tn tn3">3</div><div class="bst-arr">→</div><div class="tn tn6">6</div></div><div class="bst-cnt tc">✔ 3 passos</div></div></div><div class="bst-sub">procurando 6 em [8, 3, 10, 1, 6]</div></div>`,
      advanced: [
